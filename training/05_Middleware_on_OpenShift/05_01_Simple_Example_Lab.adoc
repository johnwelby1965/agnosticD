...
+
.$HOME/ocp4_workload_example_vars.yaml
[source,sh]
----
...
export WORKLOAD="ocp4_workload_${USER}" <5>
----
...
ansible-playbook -i ${TARGET_HOST}, -vvv ./configs/ocp-workloads/ocp-workload.yml \
    -e @$HOME/ocp4_workload_${USER}_vars.yaml \
    -e"ansible_ssh_private_key_file=~/.ssh/keytoyourhost.pem" \
...
This file should be saved at `$HOME/ocp4_workload_$USER`.
+
[source,sh]
----
# You can set any variable
